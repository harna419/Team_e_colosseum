	    	...
	    	$(this).ready(function(){ 		        
	    		$('.receive').on('click',function(e){
		    		...
		    		var recname = $('.receive').eq($(".receive").index($(this))).html()
	   				...
	   				$("#content").append('<div id="messagebox" align="center"><table><tr><td id="123">'+recname+'</td></tr><tr><td><textarea id="456" align="center" rows=15 cols=38></textarea></td></tr></table></div>');
	   				$("#messagebox").css('left',x);
	   				$("#messagebox").css('top',y);
	   				$("#messagebox").append('<br><div align="center"><button id="msubmit">전송</button> <button id="mreset">취소</button></div>');
