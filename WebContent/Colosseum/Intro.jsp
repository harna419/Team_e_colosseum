...
<link rel="stylesheet" type="text/css" href="Style/Intro_css.css">
<script type="text/javascript" src="<%=request.getContextPath() %>/Colosseum/Script/IntroScript.js"></script> 
</head>
<body>
...
$(document).ready(function() {
	...
	$('.colour').css('height', Math.floor(window_height/8) );
	$('.colour').last().css('height', Math.floor(window_height/8) + window_height%8);
	...
	*/
	...
	$('.colour_link').click(function(event) { //메뉴 하이퍼 링크 건들었을때.
	...
	$('.colours .colour_link').hover(function() {
		if ($('.colours').is('.moved') && $(this).attr('data-current') == "false" && !window.ios)
		{
			...
			$(this).children().first().stop().animate({'margin-left': 150});
...
<div class="side_menu">
<div><span class="side_button">test</span></div>
<div><span class="side_button">test</span></div>
<div><span class="side_button">test</span></div>
<div><span class="side_button">test</span></div>
<div><span class="side_button">test</span></div>
...
<div class="cover">
<!-- <img align="center" src="../Imgs/Test_Text_Button.png" onclick=test()>
 -->
</div>
